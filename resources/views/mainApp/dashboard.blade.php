                            ...
                            <div class="inbox-wid">
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-1.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-2.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-3.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-4.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-5.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img float-start me-3"><img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-6.jpg" class="avatar-sm rounded-circle" alt=""></div>
                    ...
                    <div class="card widget-user">
                        ...
                        <div class="p-4">
                            <div class="float-start mt-2 me-3">
                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-2.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-centered table-vertical table-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-2.jpg" alt="user-image" class="avatar-xs rounded-circle me-2" /> Herbert C. Patton
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-3.jpg" alt="user-image" class="avatar-xs rounded-circle me-2" /> Mathias N. Klausen
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-4.jpg" alt="user-image" class="avatar-xs rounded-circle me-2" /> Nikolaj S. Henriksen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                                $954
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-5.jpg" alt="user-image" class="avatar-xs rounded-circle me-2" /> Lasse C. Overgaard
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-6.jpg" alt="user-image" class="avatar-xs rounded-circle me-2" /> Kasper S. Jessen
                                            </td>
                                            <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                            <td>
                                                $8,844
                                ...
                                <table class="table align-middle table-centered table-vertical table-nowrap mb-1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>#12354781</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-1.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> Riverston Glass Chair
                                            </td>
                                        ...
                                        <tr>
                                            <td>#52140300</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-2.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> Shine Company Catalina
                                            </td>
                                            <td><span class="badge rounded-pill bg-success">Delivered</span></td>
                                            <td>
                                                $1,024
                                        ...
                                        <tr>
                                            <td>#96254137</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-3.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> Trex Outdoor Furniture Cape
                                            </td>
                                        ...
                                        <tr>
                                            <td>#12365474</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-4.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> Oasis Bathroom Teak Corner
                                            </td>
                                        ...
                                        <tr>
                                            <td>#85214796</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-5.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> BeoPlay Speaker
                                            </td>
                                            <td><span class="badge rounded-pill bg-success">Delivered</span></td>
                                            <td>
                                                $584
                                        ...
                                        <tr>
                                            <td>#12354781</td>
                                            <td>
                                                <img src="{{ asset('ladun/lexa/') }}/assets/images/users/user-6.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> Riverston Glass Chair
                                            </td>
                                            <td><span class="badge rounded-pill bg-success">Delivered</span></td>
                                            <td>
                                                $185
